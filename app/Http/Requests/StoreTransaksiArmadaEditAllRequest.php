...
class StoreTransaksiArmadaEditAllRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        $detailValidator = validator($detailData, [
            ...
            '*.armadaid.required' => 'armada id  wajib diisi',
            '*.armadanama.required' => 'armada  wajib diisi',
