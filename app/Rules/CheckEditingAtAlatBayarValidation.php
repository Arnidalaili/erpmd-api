...
class CheckEditingAtAlatBayarValidation implements Rule
{
    /**
    ...
    public function passes($attribute, $value)
    {
        ...
        // $editingat = new DateTime(date('Y-m-d H:i:s', strtotime($alatBayar->editing_at)));
        // $updatedat = new DateTime($penerimaanGiro->updated_at->toDateTimeString());
        // $diff = $editingat->diff($updatedat);

        // cek user
        if ($alatBayar->editingby != $user) {
            return false;
        }
