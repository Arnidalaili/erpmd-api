...
class CheckEditingAtGroupProductValidation implements Rule
{
    /**
    ...
    public function passes($attribute, $value)
    {
        ...
        // $editingat = new DateTime(date('Y-m-d H:i:s', strtotime($groupProduct->editing_at)));
        // $updatedat = new DateTime($penerimaanGiro->updated_at->toDateTimeString());
        // $diff = $editingat->diff($updatedat);

        // cek user
        if ($groupProduct->editingby != $user) {
            return false;
        }
