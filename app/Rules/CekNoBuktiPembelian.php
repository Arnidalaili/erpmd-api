...
class CekNoBuktiPembelian implements Rule
{
    /**
    ...
    public function passes($attribute, $value)
    {
        ...
        $hasil_query = $query->toArray();
        $dataEmpty = true;

        foreach ($hasil_query as $item) {
            if ($item->nobuktipembelian !== '') {
                $dataEmpty = false;
            } 
        }
    ...
    {
        return app(ErrorController::class)->geterror('NBPK')->keterangan;
    }
}
